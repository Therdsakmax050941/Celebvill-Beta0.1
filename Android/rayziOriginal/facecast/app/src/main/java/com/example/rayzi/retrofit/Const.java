...
public class Const {
    ...
    public static final String FIREBASE_DEVICE_TOKEN = "";
    ...
    public static final int WATCH = 101;
    public static final String ITEM_BASE_URL = "https://tejtokapp.sgp1.digitaloceanspaces.com/uploads/";
    public static final String DUMMYVIDEO = "https://res.cloudinary.com/dn9grdmmd/video/upload/v1604837264/profile_videos/tjo6bozc98hzg8nc0m3x.mp4";
    ...
    public static final String EVENT_GETHOSTCOIN = "getHostCoin";
    ...
    public static final String EVENT_CALL_BUSY = "evencall busy";
    ...
    public static final String FAKEHOST = "fakeHost";
    ...
    public static String LoginIs = "LoginIs";
